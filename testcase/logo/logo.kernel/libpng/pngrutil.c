...
#     endif
      ...
      {
#        if PNG_ZLIB_VERNUM < 0x1240
            ret = zlib_inflateReset(&png_ptr->zstream);
#        else
...
#        endif
      ...
      {
#        if PNG_ZLIB_VERNUM < 0x1240
            ret = zlib_inflateInit(&png_ptr->zstream);
#        else
            ret = zlib_inflateInit2(&png_ptr->zstream, window_bits);
#        endif
    ...
    /* OUTPUT: */ png_bytep output, png_alloc_size_t *output_size_ptr)
{
   if (png_ptr->zowner == owner) /* Else not claimed */
   {
      ...
      do
      {
          ...
          */
         ret = zlib_inflate(&png_ptr->zstream, avail_out > 0 ? Z_NO_FLUSH :
   ...
   if (limit >= prefix_size + (terminate != 0))
   {
      ...
      if (ret == Z_OK)
      {
         ...
         if (ret == Z_STREAM_END)
         {
             ...
             * maintained.
             */
            if (zlib_inflateReset(&png_ptr->zstream) == Z_OK)
            {
   ...
   int finish)
{
   if (png_ptr->zowner == png_ptr->chunk_name)
   {
      ...
      do
      {
          ...
          * streams.
          */
         ret = zlib_inflate(&png_ptr->zstream,
   ...
   png_alloc_size_t avail_out)
{
   ...
   do
   {
       ...
       */
      ret = zlib_inflate(&png_ptr->zstream, Z_NO_FLUSH);
