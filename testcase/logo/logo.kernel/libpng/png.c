...
#  endif
         ...
         if (png_user_version_check(&create_struct, user_png_ver))
         {
            ...
            if (png_ptr != NULL)
            {
               ...
               */
               /* for linux kernel */
               create_struct.zstream.workspace = png_malloc_warn(&create_struct,
                       max(zlib_inflate_workspacesize(),
...
png_reset_zstream(png_structrp png_ptr)
{
   ...
   return (zlib_inflateReset(&png_ptr->zstream));
}
#endif /* PNG_READ_SUPPORTED */
...
#        endif
            ...
            intent == png_sRGB_checks[i].intent)
         {
            ...
            if (adler == 0)
            {
               adler = zlib_adler32(0, NULL, 0);
               adler = zlib_adler32(adler, profile, length);
            }
