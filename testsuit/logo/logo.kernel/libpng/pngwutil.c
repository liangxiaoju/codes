...
#        endif
      ...
      {
         if (zlib_deflateEnd(&png_ptr->zstream) != Z_OK)
       ...
       */
      if (png_ptr->flags & PNG_FLAG_ZSTREAM_INITIALIZED)
         ret = zlib_deflateReset(&png_ptr->zstream);

      else
      {
         ret = zlib_deflateInit2(&png_ptr->zstream, level, method, windowBits,
            memLevel, strategy);
   ...
   compression_state *comp, png_uint_32 prefix_len)
{
    ...
    */
   {
      ...
      do
      {
         ...
         /* Compress the data */
         ret = zlib_deflate(&png_ptr->zstream,
   ...
   png_alloc_size_t input_len, int flush)
{
   ...
   for (;;)
   {
      ...
      ret = zlib_deflate(&png_ptr->zstream, input_len > 0 ? Z_NO_FLUSH : flush);
