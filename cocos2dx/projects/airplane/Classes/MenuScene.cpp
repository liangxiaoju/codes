...
bool MenuLayer::init(RenderTexture *texture) {
    ...
    do {
        ...
        auto l1 = Label::createWithSystemFont("Back", "arial", 35);
        ...
        btn_back->setPosition(s.width/2, s.height/2+80);
        btn_back->setPreferredSize(Size(s.width*2/3, 50));

        Scale9Sprite *s2 = Scale9Sprite::createWithSpriteFrame(sf);
        s2->setColor(Color3B::GRAY);
        auto l2 = Label::createWithSystemFont("Restart", "arial", 35);
        ...
        btn_restart->setPreferredSize(Size(s.width*2/3, 50));

        Scale9Sprite *s3 = Scale9Sprite::createWithSpriteFrame(sf);
        s3->setColor(Color3B::GRAY);
        auto l3 = Label::createWithSystemFont("Exit", "arial", 35);
        ...
        btn_exit->setPosition(s.width/2, s.height/2-80);
        btn_exit->setPreferredSize(Size(s.width*2/3, 50));
